HaveACupOfTeaは、従来のバイクの操作表示に加えて、アクセル及びブレーキの入力履歴があったらいいな...という想いを実現した革新的なツールです。
...
\Texture下の各フォルダ内にテクスチャが格納されています。
...
左スティックのテクスチャは非操作時と操作時とで切り替わるようになっていますが、この切替の閾値はTrialsRisingのものと一致していません。
将来的には一致させたいと考えています。
